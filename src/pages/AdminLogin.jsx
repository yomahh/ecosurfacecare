  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f5faf7] p-5">
      <section className="w-full max-w-md rounded-3xl bg-white p-8 shadow-xl">
        <div className="grid h-12 w-12 place-items-center rounded-2xl bg-emerald-50 text-[#228B22]"><LockKeyhole /></div>
        ...
        <Link to="/" className="mt-6 block text-center font-semibold text-[#228B22]">Return to website</Link>
      </section>
    </main>
  );
}
