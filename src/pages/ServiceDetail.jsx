        ...
        <div className="container-site grid gap-12 lg:grid-cols-[1.3fr_.7fr]">
          <div>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {service.features.map(feature => <div key={feature} className="flex items-center gap-3 rounded-2xl border border-slate-200 p-4"><CheckCircle2 className="text-[#0b6f63]" /> <span className="font-semibold">{feature}</span></div>)}
            </div>
          </div>
          <aside className="rounded-3xl bg-[#f5faf7] p-7">
            ...
            <Link to="/request-a-quote" className="mt-6 inline-block rounded-full bg-[#0b6f63] px-5 py-3 font-bold text-white">Request a quote</Link>
          </aside>
        </div>
      </section>
    </>
