...
const PHONE_NUMBER = "447XXXXXXXXX";
    ...
    >
      ...
      >
        <a
          ...
          className="group flex items-center gap-3 rounded-full bg-white py-2 pl-4 pr-2 text-sm font-bold text-[#17352f] shadow-xl ring-1 ring-slate-200 transition hover:-translate-y-0.5"
